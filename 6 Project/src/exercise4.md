...
__GET /api/v1/recipes__ - получение списка рецептов

__POST /api/v1/recipes__ - создание нового рецепта
...
```
__PATCH /api/v1/recipes/1__ - обновление и редактирование рецепта

__DELETE /api/v1/recipes/15__ - удаление рецепта